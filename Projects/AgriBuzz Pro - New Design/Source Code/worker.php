...
if($_SESSION['randnumber']  == $_POST['randnumber'])
{
	if(isset($_POST['submit']))
	{
		...
		// start
// 		$target_dir = "documents/adhaar/";
// 		$target_dir_pan = "documents/pan/";
// $target_file = $target_dir . basename($_FILES["adhaar"]["name"]);
// $target_file_pan = $target_dir_pan . basename($_FILES["pan"]["name"]);
// move_uploaded_file($_FILES["adhaar"]["tmp_name"], $target_file);
// move_uploaded_file($_FILES["pan"]["tmp_name"], $target_file_pan);
move_uploaded_file($_FILES['adhaar']['tmp_name'],"documents/adhaar/" . $imgname1);
move_uploaded_file($_FILES['pan']['tmp_name'],"documents/pan/" . $imgname1);
...
<div class="form-row">
	...
	<div class="col-md-6 form-group">
		Adhaar  <font color="#FF0000">*</font>
		<input type="file" name="adhaar" id="adhaar"  class="form-control">
		</div>
		<div class="col-md-6 form-group">
