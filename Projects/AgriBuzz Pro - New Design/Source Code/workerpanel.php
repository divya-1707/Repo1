...
?>                
							...
							<table class="table table-striped table-bordered" style="width:100%" class="datatable">
							  <tbody>
								...
								<tr>
							      <th height="35" align="left"><strong>Adhaar:</strong></th>
							      <td><a href='documents/adhaar/<?php echo $rsdisp['biodata']; ?>'>View Adhaar</a>							  
</td>
						        </tr>
								<tr>
							      <th height="35" align="left"><strong>Pan:</strong></th>
							      <td><a href='documents/pan/<?php echo $rsdisp['biodata']; ?>'>View Pan</a>							  
</td>
						        </tr>
							    <tr>
